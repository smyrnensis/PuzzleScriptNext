...
(function(mod) {
    if (typeof exports == "object" && typeof module == "object") // CommonJS
        ...
        var PRELUDE_COMMAND_WORDS = [
            ...
            ["three_dimensions", "", "Enables 3D level, direction, rule, and render-frame handling."],
            ["orthographic_camera", "", "Uses a 3D camera without perspective size distortion."],
            ["perspective_camera", "", "Uses a 3D camera with perspective size distortion."],
            ["camera_angle", "0 90", "Sets the 3D camera yaw and pitch in degrees."],
            ["camera_zoom", "1.25", "Sets the 3D camera framing zoom."],
            ["camera_view_angle", "35", "Sets the perspective 3D camera view angle in degrees."],
